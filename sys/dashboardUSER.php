...
<body>
    <div class="d-print-block navBar">
          ...
          <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li class="nav-item ">
                  <a class="nav-link " href="dashboardUSERchamado.php">abrir chamado</a>
              </li>
              <li class="nav-item ">
    ...
    <div class="container-xs divTable">
        <table class="table">
            <p class="text-center fs-1">seus chamados abertos</p>
            <thead>
                <tr>
            ...
            $consultachamado = $db->query("SELECT * FROM chamado where nome = '{$_SESSION['sys'][0]['nome']}'");
